    ...
    <div className="mx-auto max-w-2xl">
      ...
      <div className="rounded-[1.75rem] sm:rounded-[2rem] bg-green-ink text-cream shadow-panel overflow-hidden text-center px-5 sm:px-10 py-10 sm:py-14">
        ...
        <p className="mt-4 text-cream/75 text-sm sm:text-base max-w-md mx-auto leading-relaxed">
          You&rsquo;re now one step closer to investing with ETICO{firstName ? `, ${firstName}` : ''}. We&rsquo;re
          starting with a small group of early users before opening the platform more widely, and we&rsquo;ll
          contact you when your early-access invitation is ready. Check your inbox for your confirmation email.
        </p>
